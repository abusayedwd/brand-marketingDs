...
const TermCondition = () => {
  ...
  const { data, isLoading } = useGetContentQuery("terms");
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-end justify-between gap-3">
        <div>
          <h1 className="page-title">{page?.title || "Terms and Conditions"}</h1>
          <p className="page-subtitle">Rendered HTML preview for the public website.</p>
        </div>
        <Button type="primary" onClick={() => navigate("/dashboard/settings/edittermcondition")}>
          Edit
        </Button>
      </div>
      <div className="panel">
